...
<div class="dashboard-container">
    ...
    <main class="dashboard-main-content">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--space-32); flex-wrap: wrap; gap: var(--space-16);">
            ...
            <a href="/services" class="btn btn-secondary">Services Directory</a>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value"><?php echo (int)($stats['services'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value"><?php echo (int)($stats['requests'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-value"><?php echo (int)($stats['reviews'] ?? 0); ?></div>
